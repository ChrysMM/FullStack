 ...
 */
final class Version20200806095533 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, format_id INT NOT NULL, title VARCHAR(255) NOT NULL, abstract LONGTEXT NOT NULL, date_published DATE NOT NULL, isbn VARCHAR(20) NOT NULL, edition VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_CBE5A3313DA5256D (image_id), INDEX IDX_CBE5A331D629F605 (format_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, size INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
